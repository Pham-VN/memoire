...
function_grammaticale = ["COD","Compléments du nom","Complément de lieu","COI",
                         "Complément circonstanciel de cause", 
                         "Complément de l'adjectif", "Complément d'agent"]
...
def createSentenceWithClue(corpus,fonction):
    ...
    for sentence in corpus:
        ...
        for sentence in sentences:
            ...
            dic_sentence_analyse.update({"phrase":sentence_for_exercice})
...
nom_fichier_json = "quiz_COD_COI_question_phrase_reponse.json"
