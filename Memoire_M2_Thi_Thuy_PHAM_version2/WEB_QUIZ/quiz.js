...
function setNextQuestion() {
  ...
  if (currentQuestionIndex >= shuffleQuestions.length) {
    ...
    // buttonArbreSyntaxique.style.display= "block";
...
function stopWatch() {
  ...
  let m = minutes < 5 ? "0" + minutes : minutes;
  let s = seconds < 5 ? "0" + seconds : seconds;
  ...
  data: {
    datasets: [
      ...
      },
      {
        type: 'bar',
        plugins: [ChartDataLabels],
        label: 'Temps de réponse (en seconde)',
        data: [],
        backgroundColor: [],
        datalabels: {
          formatter: (val) => (`${val} s`),
...
centerAlign.addEventListener('click', function () {
  ...
  answerButtonsElement.style.textAlign = 'center';
  document.getElementById('bodySize').style.textAlign = 'center';
});
...
const quizQuestions = [
  {
      "sentence": "J'appelle Cl\u00e9ment. => Je l’appelle.",
      "analyse": {
          "sujet": "J'",
          "verbe": "appelle",
          "obj": "Cl\u00e9ment"
  ...
  {
      "sentence": "J'aime la musique. =>  Je l’aime.",
      "analyse": {
          "sujet": "J'",
          "verbe": "aime",
          "obj": "musique"
  ...
  {
      "sentence": " Je mange un sandwich.  => Je le mange.",
      "analyse": {
          "sujet": "Je",
          "obj": "le",
          "verbe": "mange"
  ...
  {
      "sentence": "Je connais Cécile. => Je la connais.",
      "analyse": {
          "sujet": "Je",
          "obj": "la",
          "verbe": "connais"
  ...
  {
      "sentence": "Il prend les enfants dans ses bras => Ils les prend dans ses bras.",
      "analyse": {
          "sujet": "Il",
          "obj": "les",
          "verbe": "prend"
  ...
  {
      "sentence": "Je regarde moi-même dans le reflet de l’eau. => Je me regarde dans le reflet de l’eau.",
      "analyse": {
          "sujet": "Je",
          "obj": "me",
          "verbe": "regarde"
  ...
  {
      "sentence": "Pierre parle à son ami. => Pierre lui parle.",
      "analyse": {
          "sujet": "Pierre",
          "iobj": "lui",
          "verbe": "parle"
  ...
  {
      "sentence": "C’est de cela que je parle. => J’en parle.",
      "analyse": {
          "sujet": "J'",
          "iobj": "en",
          "verbe": "parle"
  ...
  {
      "sentence": "Marie ressemble à toi. => Elle te ressemble. ",
      "analyse": {
          "sujet": "Elle",
          "iobj": "te",
          "verbe": "ressemble"
  ...
  {
      "sentence": "C’est à cela que je pense.  => J’y pense.",
      "analyse": {
          "sujet": "J'",
          "iobj": "y",
          "verbe": "pense"
  ...
  {
      "sentence": "C’est de cela que je me moque. => Je m’en moque.",
      "analyse": {
          "sujet": "J'",
          "iobj": "en",
          "verbe": "moque"
  ...
  {
      "sentence": "C'est de cela qu’ il se souvient => Il s’en souvient.",
      "analyse": {
          "sujet": "Il",
          "iobj": "en",
          "verbe": "souvient"
...
quizQuestions.forEach(question => {
    ...
    if ("obj" in question.analyse) {
        ...
        phraseCell = row.insertCell(0);
        sujetCell = row.insertCell(1);
        verbeCell = row.insertCell(2);
        codCell = row.insertCell(3);   
    ...
    if ("iobj" in question.analyse) {
        ...
        phraseCell = row2.insertCell(0);
        sujetCell = row2.insertCell(1);
        coiCell = row2.insertCell(2);   
        verbeCell = row2.insertCell(3);
...
// var buttonArbreSyntaxique = document.getElementById('buttonArbreSyntaxique');
// var arbreSyntaxique = document.getElementById('arbreSyntaxique');

// buttonArbreSyntaxique.addEventListener('click',showArbreSyntaxique);

// function showArbreSyntaxique() {
//   showCorrectionButton.style.display = "none"; 
//   buttonArbreSyntaxique.style.display = "none";
//   contenuPrincipal.style.display = "none"; 
//   chartContainer.innerHTML = ""; 

//   arbreSyntaxique.style.display = "block";
